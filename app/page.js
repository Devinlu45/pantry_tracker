...
import { collection, deleteDoc, Firestore, getDoc, getDocs, setDoc , query, doc} from "firebase/firestore";
...
export default function Home() {
  ...
  const editItem = async (oldName, newName) => {
    ...
    if (oldDocSnap.exists()) {
      ...
      await setDoc(newDocRef, data); // Create new document with new name
  ...
  return (
    <Box width="100vw" height="100vw" display="flex"flexDirection="column" justifyContent="center" alignItems="center" gap={2} sx={{ backgroundColor: 'lightgreen' }}>
        <Image 
    src="/pantry.jpg"
    width={500}
    height={500}
  />
      ...
      <Modal open={open} onClose={handleClose}>
        <Box
          ...
          width={400} bgcolor="white" border="2px solid #000" boxShadow={24} p={4}
